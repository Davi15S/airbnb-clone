...
function Inspiration() {
  return (
    <div className='pb-60 space-y-7 pt-10'>
      ...
      <div className='gap-5 flex overflow-auto px-6 scrollbar-hide'>
...
function Card({ img, city, distance }) {
  return (
    <div className='h-0 pb-[80%] bg-[#cc2d4a] min-w-[60%] rounded-xl relative cursor-pointer'>
